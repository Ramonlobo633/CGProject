...
Revolver::Revolver()
{
     model = new Model3DS("../3ds/revolver/Revolver.3ds");
}

void Revolver::desenha()
{
    glPushMatrix();
        Objeto::desenha();
        ...
        glRotatef(0,1,0,0); //alinhar o objeto 3ds com os eixos, deixando ele para cima de acordo com o eixo Y
        glTranslatef(2,0,0); //trazer objeto 3ds para origem
